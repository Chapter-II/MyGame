...
def test_unseen_village_population_is_last_known_not_live() -> None:
    ...
    hidden_snapshot = world.observation(Faction.PLAYER)
    assert int(hidden_snapshot.known_villages[0]["population"]) == known_population
