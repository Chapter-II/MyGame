...
BRIDGE_RADIUS: float = 52.0              # bridge protection/speed radius (world units)
...
RIVER_CROSSING_SAMPLES: int = 48         # samples for river crossing estimate
MAX_CROSSING_LOSS: float = 999.0         # HP cap for crossing loss estimate
